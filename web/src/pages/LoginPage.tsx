    ...
    <div className="flex-1 flex items-center justify-center py-[2rem] px-[1rem]">
      <div className="w-full max-w-[400px]">
        ...
        <div className="mt-[1.25rem] text-center text-[0.78rem] text-muted">
          Need an account? <Link className="text-blue-bright hover:underline" to="/signup">Sign up</Link>
        </div>
      </div>
    </div>
  </div>
...
const LoginBody = () => {
  ...
  if (!isLoaded) {
    return <div className="text-center text-[0.74rem] text-muted py-[2rem] px-[1rem]">Loading secure sign-in…</div>
  }
    ...
    return (
      <Frame>
        <div className="bg-white border border-border rounded-[14px] shadow-[0_18px_48px_rgba(10,36,99,0.08)] p-[1.75rem] text-center">
          <div className="font-inter font-bold tracking-[-0.02em] text-[1.1rem] text-navy-text m-0">Sign-in is temporarily unavailable</div>
